...
- Practice the Git workflow (status, staging, committing, pushing, pulling).  
...
- A starter file (`index.html`) has been created with basic HTML content.  
- At least three commits have been made to show progress.  

## How to View
Open the `src/index.html` file in a browser to see the starter webpage.
